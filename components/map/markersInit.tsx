...
export function MarkersInit() {
  ...
  return (
      <>
        ...
        <MarkerLabel coods={[39.85309141008037, 141.00087480682427]} str="岩手山" srcType="img" src="https://d2awen93wun6j6.cloudfront.net/dev/8mb.jpg" />
        ...
        <MarkerLabel coods={[39.5237573, 141.1242044]} str="高橋農園" srcType="img" src="/src/014_takahashinoen.jpg" />
